...
public class LogSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LogPackageImpl.TASK_ITEM: {
				TaskItem taskItem = (TaskItem)theEObject;
				T result = caseTaskItem(taskItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LogPackageImpl.TASK_TAG: {
				TaskTag taskTag = (TaskTag)theEObject;
				T result = caseTaskTag(taskTag);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LogPackageImpl.TASK_LOG: {
				TaskLog taskLog = (TaskLog)theEObject;
				T result = caseTaskLog(taskLog);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Task Log</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Task Log</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTaskLog(TaskLog object) {
		return null;
	}
