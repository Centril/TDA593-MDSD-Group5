/**
 */
package sechalmersmdsdgroup5.hotel.log.util;
 ...
 * <!-- end-user-doc -->
 * @see sechalmersmdsdgroup5.hotel.log.impl.LogPackageImpl
 * @generated
 */
public class LogAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected static LogPackageImpl modelPackage;
	...
	public LogAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = LogPackageImpl.eINSTANCE;
		}
	}
	...
	protected LogSwitch<Adapter> modelSwitch =
		new LogSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTaskLog(TaskLog object) {
				return createTaskLogAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link sechalmersmdsdgroup5.hotel.log.TaskItem <em>Task Item</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link sechalmersmdsdgroup5.hotel.log.TaskTag <em>Task Tag</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link sechalmersmdsdgroup5.hotel.log.TaskLog <em>Task Log</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTaskLogAdapter() {
		return null;
	}
