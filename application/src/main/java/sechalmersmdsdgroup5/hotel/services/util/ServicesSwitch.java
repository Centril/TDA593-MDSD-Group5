...
public class ServicesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ServicesPackageImpl.SERVICE: {
				...
				if (result == null) result = casePayable(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServicesPackageImpl.SERVICE_CONSUMER: {
				ServiceConsumer serviceConsumer = (ServiceConsumer)theEObject;
				T result = caseServiceConsumer(serviceConsumer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServicesPackageImpl.ISERVICE: {
				IService iService = (IService)theEObject;
				T result = caseIService(iService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServicesPackageImpl.SERVICE_BLUEPRINT: {
				ServiceBlueprint serviceBlueprint = (ServiceBlueprint)theEObject;
				T result = caseServiceBlueprint(serviceBlueprint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Consumer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Consumer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceConsumer(ServiceConsumer object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Blueprint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Blueprint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
