 ...
 * </p>
 * <ul>
 *   <li>{@link sechalmersmdsdgroup5.hotel.inventory.impl.ProductImpl#getName <em>Name</em>}</li>
 *   <li>{@link sechalmersmdsdgroup5.hotel.inventory.impl.ProductImpl#getAmount <em>Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductImpl extends MinimalEObjectImpl.Container implements Product {
	...
	protected EClass eStaticClass() {
		return InventoryPackageImpl.Literals.PRODUCT;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InventoryPackageImpl.PRODUCT__NAME:
				return getName();
			case InventoryPackageImpl.PRODUCT__AMOUNT:
				return getAmount();
		}
