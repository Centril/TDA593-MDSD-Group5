 ...
 * @generated
 */
public class ClientsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ClientsPackageImpl.ADDRESS: {
				Address address = (Address)theEObject;
				T result = caseAddress(address);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ClientsPackageImpl.ICLIENT: {
				IClient iClient = (IClient)theEObject;
				T result = caseIClient(iClient);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseIClient(IClient object) {
		return null;
	}
